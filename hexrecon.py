...
def install_tools():
        ...
        install = {"system updates":"sudo apt-get update -y; sudo apt-get upgrade -y",
                   ...
                   "assetfinder":"go get -v github.com/tomnomnom/assetfinder; cp "+godir+"bin/assetfinder /usr/local/bin/",
                   ...
                   "crobat":"go get -v github.com/cgboal/sonarsearch/crobat; cp "+godir+"bin/crobat /usr/local/bin/",
                   ...
                   "shuffledns":"GO111MODULE=on go get -v github.com/projectdiscovery/shuffledns/cmd/shuffledns; cp "+godir+"bin/shuffledns /usr/local/bin/",
                   "httprobe":"go get -v github.com/tomnomnom/httprobe; cp "+godir+"bin/httprobe /usr/local/bin/",
                   "dnsprobe":"GO111MODULE=on go get -v github.com/projectdiscovery/dnsprobe; cp "+godir+"bin/dnsprobe /usr/local/bin/",
                   "subjack":"go get -v github.com/haccer/subjack; cp "+godir+"bin/subjack /usr/local/bin/",
                   ...
                   "naabu":"GO111MODULE=on go get -v github.com/projectdiscovery/naabu/cmd/naabu ; cp "+godir+"bin/naabu /usr/local/bin/",
                   ...
                   "gau":"go get -v github.com/lc/gau; cp "+godir+"bin/gau /usr/local/bin",
                   "unfurl":"go get -v github.com/tomnomnom/unfurl; cp "+godir+"bin/unfurl /usr/local/bin",
                   "httpx":"cd "+toolsdir+"; git clone https://github.com/projectdiscovery/httpx.git; cd httpx/cmd/httpx; go build; mv httpx /usr/local/bin/",
                   ...
                   "meg":"go get -v github.com/tomnomnom/meg; cp "+godir+"bin/meg /usr/local/bin",
                   "gf":"go get github.com/tomnomnom/gf; cp "+godir+"bin/gf /usr/local/bin; cd "+toolsdir+"; git clone https://github.com/1ndianl33t/Gf-Patterns; cp "+toolsdir+"Gf-Patterns/*.json ~/.gf",
                   "waybackurls":"go get -v github.com/tomnomnom/hacks/waybackurls; cp "+godir+"bin/waybackurls /usr/local/bin",
